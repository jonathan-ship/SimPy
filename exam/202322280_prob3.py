...
class Process:
    def __init__(self,env,model,name,service_time,std_service_time,capacity):
        self.env=env
        self.model=model
        self.name=name
    ...
    def servicing(self,part,req):
        service_time = max(0,random.Gammavariate(self.service_time,self.std_service_time))
...
if __name__ == "__main__":
    ...
    IAT=3
    service_time_1=2
    std_service_time_1=1.0
    service_time_2=1
    std_service_time_2=1.5
    capacity=1

    env=simpy.Environment()
    model = {}
    model['source'] = Source(env,model,'source',IAT)
    model['process1'] = Process(env,model,'process1',service_time_1,std_service_time_1,capacity)
    model['process2'] = Process(env,model,'process2',service_time_2,std_service_time_2,capacity)
