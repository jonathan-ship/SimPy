...
class Part:
    def __init__(self, id):
        self.id = id
        self.step = 0
        self.process_list = ['process1', 'process2', 'sink'] #Make Process 1 & 2
...
class Process:
    def __init__(self, env, monitor, model, name, service_time, standard_deviation, capacity):
        self.env = env
        self.monitor = monitor
        self.model = model
        self.name = name
    ...
    def servicing(self, part, machine):
        service_time = abs(np.random.normal(self.service_time, self.standard_deviation)) #Service time is normal distribution.
...
if __name__ == '__main__':
    ...
    IAT = 3
    AVG_service_time_1 = 2 #Process 1
    SD_1 = 1               #Process 1
    AVG_service_time_2 = 1 #Process 2
    SD_2 = 1.5             #Process 2
    capacity = 1
    simtime = 100000
    ...
    model['process1'] = Process(env, monitor, model, 'process1', AVG_service_time_1, SD_1, capacity)
    model['process2'] = Process(env, monitor, model, 'process2', AVG_service_time_2, SD_2, capacity)
